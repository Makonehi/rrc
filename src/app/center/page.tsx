    ...
    return (
        ...
        >
            ...
            <div className="opis sm:h-[910px] xs:h-[910px] mt-[105px] w-screen flex justify-center items-center">
                <div className="lg:w-[772px] lg:h-[880px] md:w-[672px] md:h-[880px] sm:w-[572px] sm:h-[780px] xs:w-[350px] xs:h-[870px] bg-text-white rounded-[20px] xs:pl-[20px] md:pt-[30px] xs:pt-[10px]">
                    <p className="font-cormorant sm:text-[30px] xs:text-[20px] font-normal text-dark-text">Порядок действий при утрате
                        близкого человека:</p>
                    <div className="pl-[45px]">
                        <div className="relative mt-[25px]">
                            <p className="absolute left-[-30px] top-[-5px] text-dark-text font-cormorant text-[24px] font-normal">1.</p>
                            <p className="text-zinc-950 font-thin xs:text-[17px] md:text-[20px] font-raleway">Вызов сотрудника полиции</p>
                        ...
                        <div className="relative xs:mt-[15px] sm:mt-[50px]">
                            ...
                            <p className="text-zinc-950 font-thin xs:text-[17px] md:text-[20px] font-raleway">Обращение в поликлинику
                                и участка для памятника. </p>
                            <p className="text-zinc-950 font-thin xs:text-[17px] md:text-[20px] font-raleway mt-[15px]">Для оформления
                        ...
                        <div className="relative xs:mt-[15px] sm:mt-[50px]">
                            ...
                            <p className="text-zinc-950 font-thin xs:text-[17px] md:text-[20px] font-raleway">Подготовка документов
                                умершего</p>
                            <p className="text-zinc-950 font-thin xs:text-[17px] md:text-[20px] font-raleway mt-[15px]">Для оформления
                        ...
                        <div className="relative xs:mt-[15px] sm:mt-[50px]">
                            ...
                            <p className="text-zinc-950 font-thin xs:text-[17px] md:text-[20px] font-raleway">Вызов ритуального
                                агента.</p>
                            <p className="text-zinc-950 font-thin xs:text-[17px] md:text-[20px] font-raleway mt-[15px]">Чтобы организовать
