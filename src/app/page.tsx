...
export default function Home() {
    ...
    return (
        <div className="home-page prew ss:flex ss:justify-center ss:items-center relative"
            ...
            <div className="xs:mx-auto xs:pt-[100px]">
                <div className="md:flex xs:grid lg:gap-24 xs:gap-10">
                    <div className="xl:w-[550px] xl:h-[370px] lg:w-[450px] lg:h-[320px] ss:w-[350px] md:h-[220px] ss:h-[240px] xs:w-[300px] xs:h-[160] xs:rounded-[40px] ss:rounded-[60px]  bg-cart ss:px-[61px] ss:pt-[41px] xs:px-[40px] xs:pt-[20px]">
                        <p className="text-cart-title xl:text-[50px] lg:text-[40px] md:text-[30px] ss:text-[30px] xs:text-[30px] font-cormorant font-normal tracking-[0px] leading-[123%] text-center">Память</p>
                        <p className="text-text-white font-raleway font-thin xl:text-[32px] lg:text-[22px] md:text-[19px] ss:text-[19px] text-center xl:mt-[68px] lg:mt-[48px] md:mt-[28px] ss:mt-[28px] xs:mt-[15px]">Изготовление
                            памятника</p>
                    ...
                    <div className="xl:w-[550px] xl:h-[370px] lg:w-[450px] lg:h-[320px] ss:w-[350px] md:h-[220px] ss:h-[240px] xs:w-[300px] xs:h-[160] xs:rounded-[40px] ss:rounded-[60px] bg-cart ss:px-[61px] ss:pt-[12px] xs:px-[26px] xs:pt-[12px]">
                        <p className="text-cart-title xl:text-[50px] lg:text-[40px] md:text-[30px] ss:text-[30px] xs:text-[21px] ss:w-[250px] xs:w-[200px] xs:m-auto md:w-[250px] lg:w-[350px] xl:w-[450px] font-cormorant font-normal tracking-[0px] leading-[123%] text-center">
                            Районный ритуальный центр</p>
                        <p className="text-text-white font-raleway font-thin xl:text-[30px] lg:text-[20px] md:text-[15px] ss:text-[20px] text-center xl:mt-[30px] lg:mt-[25px] md:mt-[20px] ss:mt-[20px]">Организация
                            и
                            проведение похорон</p>
                        <div className="flex justify-center">
                            <Link href="/center">
                                <div
