            ...
            >
                <div className="xs:mx-auto xs:pt-[100px]">
                    <div className="md:flex xs:grid lg:gap-24 xs:gap-10">
                        <div
                            className="xl:w-[550px] xl:h-[370px] lg:w-[450px] lg:h-[320px] ss:w-[350px] md:h-[220px] ss:h-[240px] xs:w-[300px] xs:h-[160] xs:rounded-[40px] ss:rounded-[60px]  bg-cart ss:px-[61px] ss:pt-[41px] xs:px-[40px] xs:pt-[20px]">
                        ...
                        <div
                            className="xl:w-[550px] xl:h-[370px] lg:w-[450px] lg:h-[320px] ss:w-[350px] md:h-[220px] ss:h-[240px] xs:w-[300px] xs:h-[160] xs:rounded-[40px] ss:rounded-[60px] bg-cart ss:px-[61px] ss:pt-[12px] xs:px-[26px] xs:pt-[12px]">
