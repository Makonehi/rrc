        ...
        <>
            <Head>
                ...
                <meta name="description"
                      content="Компания «Память» — изготовление ритуальных памятников в п. Кез и Дебесах в Удмуртской Республике. Памятники из гранита, мрамора, габбро и других видов натурального камня. Индивидуальный подход, портреты, гравировка, установка и доставка. Закажите памятник на могилу с гарантией качества."/>

                <meta name="keywords"
                      content="памятники Кез, памятники на могилу, гранитные памятники, мраморные памятники, надгробия, гравировка, портрет на памятнике, установка памятников, ритуальные памятники, изготовление памятников, черный гранит, габбро, ритуальные товары, памятники Удмуртия"/>
                    ...
                    <div
                        ...
                        <div className="lg:pl-[45px] md:pl-[35px] xs:pl-[20px]">
                            ...
                            <div className="relative lg:mt-[50px] md:mt-[45px] xs:mt-[17px]">
                                ...
                                <p className="text-zinc-950 font-thin sm:text-[20px] xs:text-[15px] font-raleway">Изучение
                                    правил и
                            ...
                            <div className="relative lg:mt-[50px] md:mt-[45px] xs:mt-[17px]">
                                ...
                                <p className="text-zinc-950 font-thin sm:text-[20px] xs:text-[15px] font-raleway">Определение
                                    бюджета.</p>
                                <p className="text-zinc-950 font-thin sm:text-[20px] xs:text-[15px] font-raleway md:mt-[15px] xs:mt-[7px]">Размер
                                    и
                                    форма
                            ...
                            <div className="relative lg:mt-[50px] md:mt-[45px] xs:mt-[17px]">
                                ...
                                <p className="text-zinc-950 font-thin sm:text-[20px] xs:text-[15px] font-raleway">Учёт
                                    климатических
                                    условий
                                    региона.</p>
