        ...
        <div className="overflow-x-hidden">
            <div className="bg-cover bg-no-repeat overflow-hidden pt-10"
                ...
                <div className="w-[1225px] mx-auto px-7">
                    ...
                    <div className="">
                        <p className="text-header-ul font-raleway text-[32px] font-thin mt-[35px]">Для обеспечения достойного прощания с умершим необходимо тщательно подготовиться и правильно организовать церемонию,</p>
                        <p className="text-header-ul font-raleway text-[32px] font-thin mt-[55px]">По поводу адреса и бронирования прощального зала звоните по указанному номеру в <Link href="/contact"><span className="hover:text-micro-text border-b border-dark-text hover:border-micro-text">контактах</span></Link>.</p>
